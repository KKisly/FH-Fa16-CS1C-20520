...
/**
 * 
 * Class with methods for mergeSort, heapSort and quickSort
 * @author Intrepid
 *
 */
public class FHsort
{
	...
	public static int QS_RECURSION_LIMIT;
/**
 * Constructor for the FHsort in order to instantiate object and pass QS_RECURSION_LIMIT value
 * @param RECURSION_LIMIT
 */
	public FHsort(int RECURSION_LIMIT){
		QS_RECURSION_LIMIT = RECURSION_LIMIT;
	}
   ...
   // percolateDown()
   /**
    * heapSort method for arranging arrays
    * @param a
    * @param hole
    * @param arraySize
    */
...
/**
 * method for checking Recursion Limit
 * @param newLim
 * @return
 */
 ...
 */
   ...
   // public quicksort
   /**
    * public part of quicksort method
    * @param a
    */
   public static < E extends Comparable< ? super E > >
   void quickSort( E[] a )
